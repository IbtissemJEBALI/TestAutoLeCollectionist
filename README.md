...
### Step8 : How to run tests with record ###
    ...
    - npx cypress run --browser ${{ inputs.Browsers }} --record --key recorder_key_from_cypress.io --config-file cypress/ConfigsFiles/${{ inputs.Plateforme }}/${{ inputs.ConfigFiles }}
...
<img width="1432" alt="Capture d’écran 2023-03-13 à 13 14 39" src="https://user-images.githubusercontent.com/125995511/224698779-e0795a02-e19c-44b1-a270-e7f77e13e7a8.png">
